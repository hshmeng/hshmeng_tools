...
{
    public partial class CommonPortsWindow : Window
    {
        public CommonPortsWindow()
        {
            InitializeComponent();

            // 占位符文字，可以替换成实际内容
            ContentTextBlock.Text = @"这里是常见端口作用及其服务内容：
...
来源：https://blog.csdn.net/qq_34646546/article/details/88545165
";
        }
    }
}